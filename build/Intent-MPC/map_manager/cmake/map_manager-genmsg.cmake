...
get_filename_component(_filename "/home/ff/intent-mpc/src/Intent-MPC/map_manager/srv/CheckPosCollision.srv" NAME_WE)
add_custom_target(_map_manager_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "map_manager" "/home/ff/intent-mpc/src/Intent-MPC/map_manager/srv/CheckPosCollision.srv" ""
)

get_filename_component(_filename "/home/ff/intent-mpc/src/Intent-MPC/map_manager/srv/RayCast.srv" NAME_WE)
add_custom_target(_map_manager_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "map_manager" "/home/ff/intent-mpc/src/Intent-MPC/map_manager/srv/RayCast.srv" "geometry_msgs/Point"
)
